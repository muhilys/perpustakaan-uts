...
# Data buku
books = [
    {'id': 1, 'judul': 'Buku Manajemen Jaringan', 'tersedia': True, 'letak': 'Rak 1'},
    {'id': 2, 'judul': 'Buku Pemrograman Berorientasi Objek', 'tersedia': False, 'letak': 'Rak 2'},
    {'id': 3, 'judul': 'Buku Kecerdasan Buatan', 'tersedia': True, 'letak': 'Rak 3'}
]
...
def pinjam_buku():
    ...
    for book in books:
        if book['id'] == id_buku and book['tersedia']:
            book['tersedia'] = False
            print("\nPemijaman berhasil!")
            print(f"Nama Perpustakaan: Perpustakaan Kota")
            print(f"Nama: {nama}")
...
def main():
    while True:
        print("Selamat datang di Perpustakaan Kota")
